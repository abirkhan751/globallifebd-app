    ...
    private Bitmap downloadBitmap(String urlStr) {
        ...
        try {
            ...
            while (redirects < 5) {
                ...
                conn.setRequestProperty("User-Agent", "Mozilla/5.0 (Linux; Android 10; Mobile) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36 GlobalLifeBDApp/1.0.0");
